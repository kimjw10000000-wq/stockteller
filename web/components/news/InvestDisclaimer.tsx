...
const DISCLAIMER_BODY =
  "본 기사는 금융감독원 전자공시시스템(DART)의 공식 공시 자료를 바탕으로 작성된 단순 정보 제공 목적의 콘텐츠이며, 특정 종목에 대한 매수 또는 매도 추천이 아닙니다. 기사에 포함된 시장 전망 및 분석은 본지의 주관적 견해를 포함할 수 있으며 실제 사실과 다를 수 있습니다. 투자에 대한 최종 결정과 책임은 투자자 본인에게 있으며, 본 매체는 본 정보를 바탕으로 행해진 어떠한 투자 결과에 대해서도 법적 책임을 지지 않습니다.";
