...
export function AdminRichTextEditor({
  value,
  onChange,
  placeholder = "기사 본문을 작성하세요. 이미지는 드래그·붙여넣기(Ctrl+V) 또는 툴바로 삽입할 수 있습니다.",
  editorKey,
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-input-background">
      ...
      <EditorContent editor={editor} className="admin-rich-editor min-h-[320px] px-3 py-3 text-sm text-foreground" />
    </div>
  );
}
