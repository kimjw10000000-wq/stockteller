    ...
    return NextResponse.json(
      {
        items: items.map((r) => ({
          ...
          isUnlimitedShelf: r.is_unlimited_shelf ?? false,
          totalRegisteredOfferingCapacity: r.total_registered_offering_capacity,
          registeredCapacityUpdatedAt: r.registered_capacity_updated_at,
        })),
        q,
        count: items.length,
      },
